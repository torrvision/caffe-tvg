...
class ROIPoolingLayer : public Layer<Dtype> {
 public:
  ...
  void set_pool_height_width (const int height, const int width, Dtype spatial_scale);
  void transfer_pooling_switches ( Blob<int>* to_copy_in);
  void set_pooling_switches ( Blob<int>* to_copy_from);
