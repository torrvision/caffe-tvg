...
/*!
 * These are fillers contributed in https://github.com/BVLC/caffe/pull/4198/files which have not been merged into Caffe
 * In this pull request, they replaced the bilinear filler with a more general version, and also added upgrade scripts so that old models could be convered to the new ones.
 * Here, I am skipping that.
 * So compatibility with the previous bilinear filler remains, and we do not need to updgrade old model files
 */
